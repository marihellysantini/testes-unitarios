...
public class LocacaoServiceTest_PowerMock {
	...
	/**
	 * Exemplo de uso com métodos estáticos. Anotado como @ignore pois está sendo utilizado a classe java.util.Date
	 * ao invés de Calendar. Mantido apenas para fins de exemplo de uso. 
	 * @throws Exception
	 */
	@Ignore
	@Test
